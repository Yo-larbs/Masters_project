...
plink_total_annovar_vector=plink_total_annovar_vector[!(plink_total_annovar_vector$ExonicFunc.ensGene49=='synonymous SNV'),]
...
png("Regenie_manhattan_plot.png", width = 3200, height = 1600,res = 300 )
manhattan(Regenie_vector_for_Manhattan,chr = "CHROM",bp = "POS",snp ="ID",p = "P" ,col = c("red3","lightblue","yellow4","purple","pink","tan","maroon","black","grey44","turquoise","blue","orange","magenta","brown4","gold","purple4","lightblue4","yellow","green4","navy","grey70","lightgreen","khaki3"),chrlabs = c(1:22),annotatePval = 0.0005,annotateTop = F,suggestiveline = T,)
dev.off()
